...
void app_main(void){
  ...
  xTaskCreate(Control_Loop, "Control Loop", 4096, NULL, 3, &xControl_Loop);       // Using about 1.8kB stack
  xTaskCreate(TCP_Client_Task, "tcp_client", 4096, NULL, 4, &xTCP_Client);        // Using about 1.9kB stack
